...
final class PresetStore {
    ...
    @AppStorage("voiceEnabled") var voiceEnabled: Bool = true
    @AppStorage("hapticsEnabled") var hapticsEnabled: Bool = true
    @AppStorage("speechRate") var speechRate: Double = 0.5
    @AppStorage("countInEnabled") var countInEnabled: Bool = false
    @AppStorage("keepScreenAwake") var keepScreenAwake: Bool = false
